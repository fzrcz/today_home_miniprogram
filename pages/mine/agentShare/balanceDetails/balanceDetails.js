...
Page({
  ...
  onLoad: function(options) {
    ...
    console.log('agentId：', this.data.agentId)
  ...
  getAllBalanceDetailList: function() {
    ...
    wx.showLoading({
      ...
      util.doGet("/business/agent/commissionRecodList", data, function(res) {
        wx.hideLoading();
  ...
  swichTab0: function(e) {
    ...
    //     icon: 'loading'
    //   }),
    //   util.doGet("/business/agent/commissionRecodList", data, function(res1) {
    //     wx.hideLoading();
    //     console.log('账户明细的全部：')
    //     console.log(res1)
    //     if (res1.success) {
  ...
  swichTab1: function(e) {
    ...
    //     icon: 'loading'
    //   }),
    //   util.doGet("/business/agent/commissionRecodList", data, function(res2) {
    //     wx.hideLoading();
    //     console.log('账户明细的收入：')
    //     console.log(res2)
    //     if (res2.success) {
  ...
  getOutComeBalanceDetailList: function() {
    ...
    wx.showLoading({
      ...
      util.doGet("/business/agent/commissionRecodList", data, function(res3) {
        wx.hideLoading();
        wx.stopPullDownRefresh();
        console.log('账户明细的支出：')
        console.log(res3)
