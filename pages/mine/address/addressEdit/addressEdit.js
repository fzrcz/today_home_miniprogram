...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this
    util.doBaseGet("/account/"+ options.addrId +"/serveAddress", function (res) {
      // console.log("+++++++++++++",res)
  ...
  toDel:function(e){
    ...
    util.doDelete("/account/serveAddress/" + app.data.accountId + "/" + e.currentTarget.dataset.id, "", function (res) {
      wx.navigateBack({
        delta:1
      })
    })
